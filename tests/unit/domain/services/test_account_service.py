...
async def test_create_account_with_slug(account_service):
    ...
    # ID should be a UUID (36 characters)
    assert len(result.id) == 36
    assert "-" in result.id  # UUIDs have hyphens
...
async def test_create_account_auto_slug(account_service):
    ...
    # ID should be a UUID
    assert len(result.id) == 36
    # Account code should be first code
...
async def test_update_account_success(account_service):
    ...
    result = await account_service.update_account(
        "12345678-1234-1234-1234-123456789012", "New Name"
    )
...
async def test_delete_account_success(account_service):
    ...
    await account_service.delete_account("12345678-1234-1234-1234-123456789012")
