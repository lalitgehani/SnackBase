"""Unit tests for AccountCodeGenerator.
...
class TestValidation:
    ...
    def test_validate_valid_ids(self):
        ...
        for account_id in valid_ids:
            assert AccountCodeGenerator.validate(account_id) is True
    ...
    def test_validate_invalid_lowercase(self):
        ...
        for account_id in invalid_ids:
            assert AccountCodeGenerator.validate(account_id) is False
    ...
    def test_validate_edge_cases(self):
        ...
        assert AccountCodeGenerator.validate(None) is False
        assert AccountCodeGenerator.validate(123456) is False
        assert AccountCodeGenerator.validate([]) is False
        assert AccountCodeGenerator.validate({}) is False
...
class TestValidateWithError:
    ...
    def test_validate_with_error_valid_id(self):
        ...
        is_valid, error = AccountCodeGenerator.validate_with_error("AB1234")
    ...
    def test_validate_with_error_wrong_length(self):
        ...
        is_valid, error = AccountCodeGenerator.validate_with_error("A1234")
        assert is_valid is False
    ...
    def test_validate_with_error_non_digit_numbers(self):
        ...
        is_valid, error = AccountCodeGenerator.validate_with_error("AB12A4")
        assert is_valid is False
...
class TestGeneration:
    ...
    def test_generate_multiple_sequential(self):
        ...
        for _ in range(10):
            ...
            assert AccountCodeGenerator.validate(new_id)
...
class TestExhaustion:
    ...
    def test_generate_exhaustion_error(self):
        ...
        existing = ["ZZ9999"]
        with pytest.raises(AccountCodeExhaustedError) as exc_info:
            AccountCodeGenerator.generate(existing)
    ...
    def test_exhaustion_error_message(self):
        ...
        error = AccountCodeExhaustedError()
        message = str(error)
...
class TestRestartBehavior:
    ...
    def test_find_highest_code(self):
...
class TestEdgeCases:
    ...
    def test_letter_pair_combinations(self):
        ...
        for existing, expected in test_cases:
            assert AccountCodeGenerator.generate(existing) == expected
...
class TestSortingAndComparison:
    ...
    def test_code_sort_key(self):
        """Test that IDs sort correctly."""
        ids = ["AB0001", "AA0002", "AA0001", "BA0001", "AB0002"]
        sorted_ids = sorted(ids, key=AccountCodeGenerator._code_sort_key)
        assert sorted_ids == ["AA0001", "AA0002", "AB0001", "AB0002", "BA0001"]

    def test_find_highest_code_with_mixed_order(self):
        """Should find highest ID regardless of input order."""
        existing = {"AA0001", "ZZ9999", "AB0001", "MN5432"}
        highest = AccountCodeGenerator._find_highest_code(existing)
        assert highest == "ZZ9999"

    def test_find_highest_code_empty_set(self):
        """Empty set should return AA0000."""
        highest = AccountCodeGenerator._find_highest_code(set())
        assert highest == "AA0000"

    def test_find_highest_code_only_invalid(self):
